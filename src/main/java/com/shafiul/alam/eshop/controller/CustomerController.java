...
public class CustomerController {
      ...
      public Customer buyProducts(HttpServletRequest request){
          ...
          Customer customer = customerCrudService.findById(customerId).orElseThrow(()-> new IllegalArgumentException("invalid id: " + customerId));
          Product product = productCrudService.findById(productId).orElseThrow(()-> new IllegalArgumentException("invalid product: " + productId));
